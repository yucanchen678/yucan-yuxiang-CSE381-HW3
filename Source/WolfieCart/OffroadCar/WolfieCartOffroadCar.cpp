...
#include "WolfieCartOffroadCar.h"
#include "WolfieCartOffroadWheelFront.h"
#include "WolfieCartOffroadWheelRear.h"
...
AWolfieCartOffroadCar::AWolfieCartOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UWolfieCartOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UWolfieCartOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UWolfieCartOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UWolfieCartOffroadWheelRear::StaticClass();
