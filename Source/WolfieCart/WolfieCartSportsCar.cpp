...
#include "WolfieCartSportsCar.h"
#include "WolfieCartSportsWheelFront.h"
#include "WolfieCartSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AWolfieCartSportsCar::AWolfieCartSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UWolfieCartSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UWolfieCartSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UWolfieCartSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UWolfieCartSportsWheelRear::StaticClass();
